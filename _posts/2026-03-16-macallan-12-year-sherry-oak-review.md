...
맥캘란 12년 셰리 오크는 맥캘란이라는 브랜드의 명성을 만든 장본인이다. 사실 맥캘란이 지금처럼 "싱글 몰트의 롤스로이스"로 불리게 된 배경에는 셰리 캐스크에 대한 거의 광적인 집착이 있다. 다른 증류소들이 비용 문제로 중고 [버번](/bourbon-whiskey-characteristics-guide/) 배럴을 주로 쓸 때, 맥캘란은 처음부터 셰리 캐스크를 고집했고, "셰리 오크"라는 이름은 그 철학의 결정체인 셈.
