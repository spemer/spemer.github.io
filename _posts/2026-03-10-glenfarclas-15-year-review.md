...
**글렌파클라스 105** — 캐스크 스트렝스(60%)로 병입한 NAS 위스키. 숫자 105는 영국식 프루프(British proof) 표기인데, 글렌파클라스의 원초적인 캐릭터를 날 것 그대로 경험할 수 있다. 위스키 좀 마셔본 사람들 사이에서 가성비 캐스크 스트렝스의 끝판왕으로 통하는데, 셰리 캐스크 스트렝스 쪽으로 더 파고 싶다면 [아벨라워 아부나흐](/aberlour-abunadh-batch84-review/)도 꼭 비교해볼 만하다.
