...
발베니가 특별한 이유는 세 가지다. 자체 플로어 몰팅, 자체 쿠퍼리지(통 제작소), 그리고 1962년부터 현역인 몰트 마스터 데이비드 스튜어트. 스튜어트는 1993년에 캐스크 피니싱을 스카치 위스키에 최초로 도입한 인물이다. 버번 캐스크에서 숙성한 위스키를 셰리 캐스크로 옮겨 추가 숙성하는 이 기법이 바로 더블우드의 시작이었고, 이후 업계 전체로 퍼져 지금은 거의 표준이 된 셈이다.
...
**14년 캐리비안 캐스크** — 럼 캐스크 피니싱. 트로피컬한 달콤함이 발베니의 꿀 캐릭터와 만나 독특하다.

**17년 더블우드** — 12년의 업그레이드 버전. 5년의 추가 숙성이 주는 깊이감이 확실하다.

**21년 포트우드** — 포트 와인 캐스크 피니싱. 진한 베리 풍미가 럭셔리한 맛을 만든다.

**25년 싱글배럴** — 단일 배럴 한정판. 발베니의 최상위 라인 중 하나.
